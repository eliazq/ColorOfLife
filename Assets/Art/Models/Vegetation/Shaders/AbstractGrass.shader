...
Shader "Polytope Studio/PT_Vegetation_Plants_Shader"
{
    Properties
    {
        ...
        [Range(0, 1)] _RandomColorStrength("Random Color Strength", Float) = 0.5
    }
    ...
    SubShader
    {
        ...
        // ... existing tessellation functions ...
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/TextureStack.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/ShaderPass/ShaderPassForward.hlsl"
